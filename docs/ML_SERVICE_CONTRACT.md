...
This is the implemented HTTP contract on `feature/wind-power-baseline`. It supersedes the proposed API body in TEAM_INTEGRATION_PROPOSAL.md. The `yevgeniy` branch remains unchanged. No training job or weather download is triggered by inference.
